...
ind_summary_dapi_step5_dox <- ind_summary_dapi_4 %>% 
  group_by(Individual, Treatment, Timepoint) %>% 
  summarise(
...
plot_step5_dox_time_dapi <- ggplot(ind_summary_dapi_step5_dox,
  ...
  stat_pvalue_manual(ttest_table_dox_time_dapi,
                     ...
                     y.position = "y.position",
                     tip.length = 0.02) +
  labs(title = "Step 5: DOX Timepoint Comparisons Hoechst Intensity",
       x = "Condition",
       y = "Mean Intensity") +
  theme_custom() +
  theme(legend.position = "bottom")
...
ind_summary_dapi_step5_veh <- ind_summary_dapi_4 %>% 
  group_by(Individual, Treatment, Timepoint) %>% 
  summarise(
    Weight_Mean = Weight_Mean,
    .groups = "drop"
...
plot_step5_veh_time_dapi <- ggplot(ind_summary_dapi_step5_veh,
  ...
  stat_pvalue_manual(ttest_table_veh_time_dapi,
                     ...
                     y.position = "y.position",
                     tip.length = 0.02) +
  labs(title = "Step 5: VEH Timepoint Comparisons Hoechst Intensity",
       x = "Condition",
       y = "Mean Intensity") +
  theme_custom() +
  theme(legend.position = "bottom")
...
# save_plot(plot_nuc_count_stats,
#           filename = "NucleiCount_Boxplot_ImgLevel_EMP",
#           folder = output_folder)
...
plot_nuc_counts_ind_mean <- ggplot(ind_summary_nuc_count, 
  ...
  scale_color_manual(values = ind_cols_if) +
  scale_fill_manual(values = txtime_col_old) +
  stat_pvalue_manual(ttests_nuc_count_ind,
                     label = "p.signif", 
                     xmin = "group1",
                     xmax = "group2", 
                     tip.length = 0.02) +
  ylim(0, 400) +
  labs(title = "Assess # of Nuclei per Condition, Ind Level",
       x = "Condition", 
       y = "Mean # of Nuclei") +
  theme_custom() +
  theme(legend.position = "bottom")

plot_nuc_counts_ind_mean


#next, plot median number of nuclei

plot_nuc_counts_ind_med <- ggplot(ind_summary_nuc_count, 
...
plot_nuc_counts_ind_med

#save plots

# save_plot(plot_nuc_counts_ind_mean,
#           filename = "NucleiCount_IndLevel_Mean_EMP",
#           folder = output_folder)
# 
# save_plot(plot_nuc_counts_ind_med,
#           filename = "NucleiCount_IndLevel_Median_EMP",
#           folder = output_folder)
